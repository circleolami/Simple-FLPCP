...
from Custom.ComplexCircuit import ComplexCircuit
...
if __name__ == '__main__':
    ...
    print('|   One-round FLPCP for complex circuit   |')
    print('\\-----------------------------------------/')
    print('')
    ...
    input_vec = [Integer(i) for i in range(dim * dim * 8)]
    print('Input: ', input_vec)

    print('-------------------------------------------')

    # Define circuit
    my_circuit = ComplexCircuit(dim)
